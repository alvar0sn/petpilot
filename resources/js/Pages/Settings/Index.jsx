...
export default function SettingsIndex({ categories, items, paymentMethods, stations, checklistItems, ticketConfig, generalConfig, walkConfig, recordatoriosConfig, responsivaConfig, responsivaConfigs, planInfo, mercadoPagoConfig, teamMembers, razas }) {
