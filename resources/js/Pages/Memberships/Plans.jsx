...
const servicioLabel = { guarderia: 'Guardería', hotel: 'Hotel', estetica: 'Estética', paseo: 'Paseo', entrenamiento: 'Entrenamiento', recoleccion: 'Recolección' };
const servicioColor = { guarderia: 'bg-blue-100 text-blue-700', hotel: 'bg-purple-100 text-purple-700', estetica: 'bg-pink-100 text-pink-700', paseo: 'bg-green-100 text-green-700', entrenamiento: 'bg-amber-100 text-amber-700', recoleccion: 'bg-cyan-100 text-cyan-700' };
const SERVICES = ['guarderia', 'hotel', 'estetica', 'paseo', 'entrenamiento', 'recoleccion'];
